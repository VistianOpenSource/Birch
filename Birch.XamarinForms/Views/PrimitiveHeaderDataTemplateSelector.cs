...
{
    public class PrimitiveHeaderDataTemplateSelector : DataTemplateSelector
    {
        ...
        public PrimitiveHeaderDataTemplateSelector(XamFormsContext context,Func<IShadow<BindableObject>,PrimitiveHolder> bindingSelector,int cacheSizeLimit=0,Func<object,IPrimitive> primitiveSelector=default)
        {
            _context = context;
